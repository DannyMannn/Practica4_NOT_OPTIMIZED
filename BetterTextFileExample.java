...
public class BetterTextFileExample {
    public static void main(String[] args){
        /*
        ArrayList<String> list = lineToArray("registrosCiudadanos.txt");
        String stringg = new String("friend");
       ...
       for(int i = 0; i < list.size(); i++)
         ...
         */
        /*
       ArrayList<String> datosFecha;
       String string = removeSubArray("FECHA DE NACIMIENTO","00");
       System.out.println(string);

       Fecha fecha = Fecha.formatearFecha(string);
      fecha.mostrarFecha();
    */
    String name = formatearNombre("JUAN AVALOS SARMIENTO");
